...
$(document).ready(function () {
    ...
    $("#button-more-info").click(function () {
        ...
        var type;
        insert_request_info(dealerId, type = 1, $("#fname_more").val(), $("#lname_more").val(), contactPrefer, $("#email_more").val(), $("#phone_more").val(), $("#comment_more").val(), vinNumber);
        $.fancybox.close();
    ...
    $("#button-test-info").click(function () {
        ...
        var type;
        insert_test_drive(dealerId, type = 2, $("#fname_test").val(), $("#lname_test").val(), contactPrefer, $("#email_test").val(), $("#phone_test").val(), $("#comment_test").val(), vinNumber, date, $("#time").val());
        $.fancybox.close();
    ...
    $("#button-offer-info").click(function () {
        ...
        insert_make_offer(dealerId, type = 3, $("#fname_offer").val(), $("#lname_offer").val(), contactPrefer, $("#email_offer").val(), $("#phone_offer").val(), $("#comment_offer").val(), vinNumber, $("#offer_value").val());
        $.fancybox.close();
...
function insert_request_info(dealerId, ctmrType, ctmrFname, ctmrLname, ctmrPrefer, ctmrEmail, ctmrPhone, ctmrComment, vinnumber) {
    ...
    // leo responsive
        ...
        if (windowsize <= 700) {
            ...
            setTimeout(function () {
                $("#resSuccess").fadeOut();
                $("html, body").animate({ scrollTop: $('#mainImage').offset().top }, 100);
                $(".form-wrap").hide();
            }, 2000);
        }
    // end leo responsive
